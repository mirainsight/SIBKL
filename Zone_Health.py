...
st.set_page_config(page_title="Zone Health", page_icon="🤼")
...
dataframe2 = pd.read_excel("Zone_Health.xlsx")
...
if show_data and choose_columns:
    ...
    st.header(f"There are {len(filtered_df)} such zone(s) ({percentage}% of all zones).")
elif show_data: 
    st.dataframe(filtered_df)
    st.subheader(f"There are {len(filtered_df)} such zone(s) ({percentage}% of all zones).")
